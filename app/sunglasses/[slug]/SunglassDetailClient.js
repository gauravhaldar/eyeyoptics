      ...
      {imageFiles.map((img, idx) => (
        <motion.div
          ...
          className={`relative w-full h-20 sm:h-24 md:h-28 cursor-pointer rounded-xl shadow-md overflow-hidden
            ${selectedImage === idx + 1 ? "ring-2 sm:ring-4 ring-cyan-500 shadow-xl scale-105" : "hover:scale-105"}
          `}
        ...
        >
          ...
          <div className="flex flex-col md:flex-row gap-4">
            <div className="flex-1 rounded-lg bg-cyan-50 p-4 text-center shadow-md">
              <h3 className="font-semibold text-cyan-800">☀️ 100% UV Protection</h3>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                { label: "Frame Material", value: product.frameMaterial || "N/A" },
                { label: "Lens Material", value: product.lensMaterial || "N/A" },
                { label: "Lens Type", value: product.lensType || "N/A" },
                { label: "Warranty", value: product.warranty || "N/A" },
              ].map((item, idx) => (
                <div key={idx} className="rounded-lg p-4 shadow-md bg-gray-50 text-center">
